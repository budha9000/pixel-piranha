...
public class bearController : MonoBehaviour {
    ...
    private ZuckerManager zuckerManager;
...
//		startTime = Time.time;
        ...
        zuckerManager = GameObject.FindGameObjectWithTag("ZuckerWert").GetComponent<ZuckerManager> ();
	}
    ...
    {
        if(other.gameObject.tag == "zuckerstange")
        {
            zuckerManager.AddZucker();
